...
```{r, fig.cap="red line = 2021, green line = 2021*0.7, black line = ltm and dashed in mean of ltm, blue mass is all years"}
...
regdata %>% 
  ...
  ggplot2::geom_line(data = m30, aes(x = Date, y = Mean30), color = "green" )+
  facet_wrap(.~Location)
